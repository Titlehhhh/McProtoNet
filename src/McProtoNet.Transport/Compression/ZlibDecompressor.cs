...
using static McProtoNet.Transport.Compression.Native.Decompression;

namespace McProtoNet.Transport.Compression;

/// <summary>Provides zlib decompression through a native libdeflate decompressor handle.</summary>
