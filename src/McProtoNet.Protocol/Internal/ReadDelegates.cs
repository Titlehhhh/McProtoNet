...
public static class ReadDelegates{
    ...
    public static readonly ReadDelegate<uint> UInt32 = (ref MinecraftPrimitiveReader reader) => reader.ReadUnsignedInt();
    public static readonly ReadDelegate<long> Int64 = (ref MinecraftPrimitiveReader reader) => reader.ReadSignedLong();
    public static readonly ReadDelegate<ulong> UInt64 = (ref MinecraftPrimitiveReader reader) => reader.ReadUnsignedLong();

    public static readonly ReadDelegate<short> Int16 = (ref MinecraftPrimitiveReader reader) => reader.ReadSignedShort();
    public static readonly ReadDelegate<ushort> UInt16 = (ref MinecraftPrimitiveReader reader) => reader.ReadUnsignedShort();
