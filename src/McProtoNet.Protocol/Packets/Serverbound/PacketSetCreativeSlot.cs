    ...
    public class SetCreativeSlotPacket : IClientPacket
    {
        ...
        public virtual void Serialize(ref MinecraftPrimitiveWriter writer, int protocolVersion)
        {
            if (V340_765.SupportedVersion(protocolVersion))
                ...
                throw new ProtocolNotSupportException(nameof(ClientPacket.SetCreativeSlot), protocolVersion);
        }

        public static ClientPacket PacketId => ClientPacket.SetCreativeSlot;
