    ...
    public class UpdateCommandBlockPacket : IClientPacket
    {
        ...
        public virtual void Serialize(ref MinecraftPrimitiveWriter writer, int protocolVersion)
        {
            if (V393_769.SupportedVersion(protocolVersion))
                ...
                throw new ProtocolNotSupportException(nameof(ClientPacket.UpdateCommandBlock), protocolVersion);
        }

        public static ClientPacket PacketId => ClientPacket.UpdateCommandBlock;
