...
namespace McProtoNet.Protocol.ServerboundPackets
{
    public class SetDifficultyPacket : IClientPacket
    {
        ...
        internal sealed class V477_769 : SetDifficultyPacket
        {
        ...
        public virtual void Serialize(ref MinecraftPrimitiveWriter writer, int protocolVersion)
        {
            if (V477_769.SupportedVersion(protocolVersion))
                ...
                throw new ProtocolNotSupportException(nameof(ClientPacket.SetDifficulty), protocolVersion);
        }

        public static ClientPacket PacketId => ClientPacket.SetDifficulty;
