    ...
    public class ConfigurationAcknowledgedPacket : IClientPacket
    {
        ...
        public virtual void Serialize(ref MinecraftPrimitiveWriter writer, int protocolVersion)
        {
            if (V764_769.SupportedVersion(protocolVersion))
                ...
                throw new ProtocolNotSupportException(nameof(ClientPacket.ConfigurationAcknowledged), protocolVersion);
        }

        public static ClientPacket PacketId => ClientPacket.ConfigurationAcknowledged;
