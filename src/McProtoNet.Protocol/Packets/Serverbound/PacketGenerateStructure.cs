    ...
    public class GenerateStructurePacket : IClientPacket
    {
        ...
        public virtual void Serialize(ref MinecraftPrimitiveWriter writer, int protocolVersion)
        {
            if (V734_769.SupportedVersion(protocolVersion))
                ...
                throw new ProtocolNotSupportException(nameof(ClientPacket.GenerateStructure), protocolVersion);
        }

        public static ClientPacket PacketId => ClientPacket.GenerateStructure;
