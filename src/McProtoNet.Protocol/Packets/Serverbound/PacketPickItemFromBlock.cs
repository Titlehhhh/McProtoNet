...
namespace McProtoNet.Protocol.ServerboundPackets
{
    public class PickItemFromBlockPacket : IClientPacket
    {
        ...
        internal sealed class V769 : PickItemFromBlockPacket
        {
        ...
        public virtual void Serialize(ref MinecraftPrimitiveWriter writer, int protocolVersion)
        {
            if (V769.SupportedVersion(protocolVersion))
                ...
                throw new ProtocolNotSupportException(nameof(ClientPacket.PickItemFromBlock), protocolVersion);
        }

        public static ClientPacket PacketId => ClientPacket.PickItemFromBlock;
