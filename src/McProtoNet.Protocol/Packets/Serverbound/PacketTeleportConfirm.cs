    ...
    public class TeleportConfirmPacket : IClientPacket
    {
        ...
        public virtual void Serialize(ref MinecraftPrimitiveWriter writer, int protocolVersion)
        {
            if (V340_769.SupportedVersion(protocolVersion))
                ...
                throw new ProtocolNotSupportException(nameof(ClientPacket.TeleportConfirm), protocolVersion);
        }

        public static ClientPacket PacketId => ClientPacket.TeleportConfirm;
