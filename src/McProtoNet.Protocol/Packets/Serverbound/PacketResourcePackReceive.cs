    ...
    public class ResourcePackReceivePacket : IClientPacket
    {
        ...
        public virtual void Serialize(ref MinecraftPrimitiveWriter writer, int protocolVersion)
        {
            if (V340_764.SupportedVersion(protocolVersion))
                ...
                throw new ProtocolNotSupportException(nameof(ClientPacket.ResourcePackReceive), protocolVersion);
        }

        public static ClientPacket PacketId => ClientPacket.ResourcePackReceive;
