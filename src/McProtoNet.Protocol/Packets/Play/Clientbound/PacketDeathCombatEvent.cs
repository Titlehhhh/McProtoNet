...
namespace McProtoNet.Protocol.ClientboundPackets.Play
{
    public abstract class DeathCombatEventPacket : IServerPacket
    {
        ...
        {
            return V755_762.SupportedVersion(protocolVersion) || V763_764.SupportedVersion(protocolVersion) ||
                   V765_769.SupportedVersion(protocolVersion);
        }

        public abstract void Deserialize(ref MinecraftPrimitiveReader reader, int protocolVersion);
        public static PacketIdentifier PacketId => ServerPlayPacket.DeathCombatEvent;
