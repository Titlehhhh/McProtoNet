...
{
    public abstract class SetTitleSubtitlePacket : IServerPacket
    {
        public sealed class V755_764 : SetTitleSubtitlePacket
        {
        ...
        public sealed class V765_769 : SetTitleSubtitlePacket
        {
            public override void Deserialize(ref MinecraftPrimitiveReader reader, int protocolVersion)
            {
        ...
        public static PacketIdentifier PacketId => ServerPlayPacket.SetTitleSubtitle;
