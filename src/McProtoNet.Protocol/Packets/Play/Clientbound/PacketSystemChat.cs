...
namespace McProtoNet.Protocol.ClientboundPackets.Play
{
    public abstract class SystemChatPacket : IServerPacket
    {
        ...
        {
            return V759.SupportedVersion(protocolVersion) || V760_764.SupportedVersion(protocolVersion) ||
                   V765_769.SupportedVersion(protocolVersion);
        }

        public abstract void Deserialize(ref MinecraftPrimitiveReader reader, int protocolVersion);
        public static PacketIdentifier PacketId => ServerPlayPacket.SystemChat;
