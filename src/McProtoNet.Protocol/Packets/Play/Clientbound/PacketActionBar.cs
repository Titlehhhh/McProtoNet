...
{
    public abstract class ActionBarPacket : IServerPacket
    {
        public sealed class V755_764 : ActionBarPacket
        {
        ...
        public sealed class V765_769 : ActionBarPacket
        {
            public override void Deserialize(ref MinecraftPrimitiveReader reader, int protocolVersion)
            {
        ...
        public static PacketIdentifier PacketId => ServerPlayPacket.ActionBar;
