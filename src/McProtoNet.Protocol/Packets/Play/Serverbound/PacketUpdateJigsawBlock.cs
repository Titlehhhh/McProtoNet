...
namespace McProtoNet.Protocol.ServerboundPackets.Play
{
    public class UpdateJigsawBlockPacket : IClientPacket
    {
        ...
        {
            return V477_578.SupportedVersion(protocolVersion) || V709_764.SupportedVersion(protocolVersion) ||
                   V765_769.SupportedVersion(protocolVersion);
        }
        ...
        public static PacketIdentifier PacketId => ClientPlayPacket.UpdateJigsawBlock;
