...
namespace McProtoNet.Protocol.ServerboundPackets.Play
{
    public class ChatPreviewPacket : IClientPacket
    {
        ...
        public sealed class V759_760 : ChatPreviewPacket
        {
            ...
            internal static void SerializeInternal(ref MinecraftPrimitiveWriter writer, int protocolVersion, int query,
                string message)
            {
        ...
        public static PacketIdentifier PacketId => ClientPlayPacket.ChatPreview;
