...
[Packet("play.toClient.add_resource_pack", PacketPhase.Play, PacketDirection.Clientbound)]
...
public sealed partial record AddResourcePackPacket(Guid Uuid, string Url, string Hash, bool Forced, NbtTag? PromptMessage) : IPacket<AddResourcePackPacket>, IPacket
{
    ...
    public static PacketIdentity Identity => new("play.toClient.add_resource_pack", "AddResourcePack", PacketPhase.Play, PacketDirection.Clientbound, 3);
