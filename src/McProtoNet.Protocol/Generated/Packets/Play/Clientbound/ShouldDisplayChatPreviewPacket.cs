...
public sealed partial record ShouldDisplayChatPreviewPacket(bool ShouldDisplayChatPreview) : IPacket<ShouldDisplayChatPreviewPacket>, IPacket
{
    ...
    public static PacketIdentity Identity => new("play.toClient.should_display_chat_preview", "ShouldDisplayChatPreview", PacketPhase.Play, PacketDirection.Clientbound, 89);
