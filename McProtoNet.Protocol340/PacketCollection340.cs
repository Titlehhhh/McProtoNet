...
namespace Ddos
{
    internal class PacketCollection340 : IPacketCollection
    {
        private static Dictionary<int, Type> sp = new Dictionary<int, Type>()
        {
        ...
        private static Dictionary<int, Type> cp = new Dictionary<int, Type>()
        {
