...
Клиент намеренно тонкий. Фазы входа, логика бота и всё остальное живут
в приложении, а не здесь.

## Что из этого следует

Приложению обычно хватает пакета `McProtoNet`: он тянет остальные. Но слои
разбираются по одному, и это не случайность - как они друг с другом связаны,
разобрано в [«Кто кого знает»](02-who-knows-whom.md).
